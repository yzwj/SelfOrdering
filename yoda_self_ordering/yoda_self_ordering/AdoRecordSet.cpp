...
/*========================================================================
	Params:		
		...
		adAsyncFetchNonBlocking 指示主要线程在提取期间从未堵塞. 如果所请求
						的行尚未提取, 当前行自动移到文件末尾. 
==========================================================================*/
BOOL CAdoRecordSet::Open(CString strSQL, long lOption, CursorTypeEnum CursorType, LockTypeEnum LockType)
{
	ASSERT(m_pConnection != NULL);
	ASSERT(m_pRecordset != NULL);
	...
	{
		if (IsOpen()) Close();
		return SUCCEEDED(m_pRecordset->Open(_variant_t(m_strSQL.GetBuffer(0)), 
...
==========================================================================*/
BOOL CAdoRecordSet::Save(LPSTR strFileName, PersistFormatEnum PersistFormat)
{
	ASSERT(m_pRecordset != NULL);
	ASSERT(IsOpen());
...
BOOL CAdoRecordSet::Load(LPSTR strFileName)
{
	if (IsOpen()) Close();
...
CString CAdoRecordSet::GetFieldName(long lIndex)
{
	...
	try
	{
		strFieldName = LPSTR(m_pRecordset->Fields->GetItem(_variant_t(lIndex))->GetName());
	}
	catch (_com_error e)
	{
...
long CAdoRecordSet::GetFieldAttributes(LPSTR lpszFieldName)
{
	ASSERT(m_pRecordset != NULL);
	try
	{
...
long CAdoRecordSet::GetFieldDefineSize(LPSTR lpszFieldName)
{
	ASSERT(m_pRecordset != NULL);
	try
	{
...
long CAdoRecordSet::GetFieldActualSize(LPSTR lpszFieldName)
{
	ASSERT(m_pRecordset != NULL);
	try
	{
...
DataTypeEnum CAdoRecordSet::GetFieldType(LPSTR lpszFieldName)
{
	ASSERT(m_pRecordset != NULL);
	try 
	{
...
BOOL CAdoRecordSet::IsFieldNull(LPSTR lpFieldName)
{
	try
	{
...
FieldPtr CAdoRecordSet::GetField(LPSTR lpszFieldName)
{
	try
	{
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const _variant_t &value)
{
	ASSERT(m_pRecordset != NULL);
	try
	{
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const bool &value)
{
	ASSERT(m_pRecordset != NULL);
	#ifdef _DEBUG
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const BYTE &value)
{
	ASSERT(m_pRecordset != NULL);
	#ifdef _DEBUG
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const short &value)
{
	ASSERT(m_pRecordset != NULL);
	#ifdef _DEBUG
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const int &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const long &value)
{
	ASSERT(m_pRecordset != NULL);
	#ifdef _DEBUG
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const DWORD &value)
{
	ASSERT(m_pRecordset != NULL);
	#ifdef _DEBUG
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const float &value)
{
	ASSERT(m_pRecordset != NULL);
	#ifdef _DEBUG
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const double &value)
{
	ASSERT(m_pRecordset != NULL);
	#ifdef _DEBUG
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const COleDateTime &value)
{
	ASSERT(m_pRecordset != NULL);
	#ifdef _DEBUG
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const COleCurrency &value)
{
	ASSERT(m_pRecordset != NULL);
	#ifdef _DEBUG
...
BOOL CAdoRecordSet::PutCollect(LPSTR strFieldName, const CString &value)
{
	ASSERT(m_pRecordset != NULL);
	#ifdef _DEBUG
...
BOOL CAdoRecordSet::GetCollect(LPSTR strFieldName, COleDateTime &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetCollect(LPSTR strFieldName, COleCurrency &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetCollect(LPSTR strFieldName,  bool &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetCollect(LPSTR strFieldName,  BYTE &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetCollect(LPSTR strFieldName,  short &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetCollect(LPSTR strFieldName,  int &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetCollect(LPSTR strFieldName,  long &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetCollect(LPSTR strFieldName,  DWORD &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetCollect(LPSTR strFieldName,  float &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetCollect(LPSTR strFieldName,  double &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetCollect(LPSTR strFieldName, CString &strValue)
{
	ASSERT(m_pRecordset != NULL);
	try
	{
		...
		_variant_t value = m_pRecordset->GetCollect(_variant_t(LPSTR(strFieldName)));
		strValue = vartostr(value);
		return TRUE;	
	}
	catch (_com_error e)
...
//////////////////////////////////////////////////////////////////////
///////为了和MFC的类的函数保持一致性，添加了下列函数
BOOL CAdoRecordSet::GetFieldValue(long index, COleDateTime &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(LPSTR strFieldName, COleDateTime &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(long index, COleCurrency &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(LPSTR strFieldName, COleCurrency &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(long index,  bool &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(LPSTR strFieldName,  bool &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(long index,  BYTE &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(LPSTR strFieldName,  BYTE &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(long index,  short &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(LPSTR strFieldName,  short &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(long index,  int &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(LPSTR strFieldName,  int &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(long index,  long &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(LPSTR strFieldName,  long &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(long index,  DWORD &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(LPSTR strFieldName,  DWORD &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(long index,  float &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(LPSTR strFieldName,  float &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(long index,  double &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(LPSTR strFieldName,  double &value)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::GetFieldValue(long index, CString& strValue)
{
	ASSERT(m_pRecordset != NULL);
	if (index < 0 || index >= GetFieldsCount())
	{
...
BOOL CAdoRecordSet::GetFieldValue(LPSTR strFieldName, CString &strValue)
{
	ASSERT(m_pRecordset != NULL);
	try
	{
...
BOOL CAdoRecordSet::AppendChunk(LPSTR strFieldName, LPVOID lpData, UINT nBytes)
{
	ASSERT(m_pRecordset != NULL);
	ASSERT(lpData != NULL);
...
BOOL CAdoRecordSet::AppendChunk(LPSTR strFieldName, LPCTSTR lpszFileName)
{
	ASSERT(m_pRecordset != NULL);
	ASSERT(lpszFileName != NULL);
	BOOL bret = FALSE;
...
BOOL CAdoRecordSet::GetChunk(LPSTR strFieldName, LPVOID lpData)
{
	if (adFldLong & GetFieldAttributes(strFieldName))
...
{
	return GetChunk(GetFieldName(index).GetBuffer(0), bitmap);
}

BOOL CAdoRecordSet::GetChunk(LPSTR strFieldName, CBitmap &bitmap)
{		
	BOOL bret = FALSE;
...
==========================================================================*/
BOOL CAdoRecordSet::SetFilter(LPSTR lpszFilter)
{
	ASSERT(m_pRecordset != NULL);
	ASSERT(IsOpen());
...
==========================================================================*/
BOOL CAdoRecordSet::SetSort(LPSTR lpszCriteria)
{
	ASSERT(IsOpen());
...
/*========================================================================
	...
	匹配.). 
==========================================================================*/
BOOL CAdoRecordSet::Find(LPSTR lpszFind, SearchDirectionEnum SearchDirection)
{
	ASSERT(m_pRecordset != NULL);
...
BOOL CAdoRecordSet::ClearMemory()
{
	//m_pRecordset.Release();
	//m_pRecordset = NULL;
	return true;
