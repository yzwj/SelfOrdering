...
public:
	// 数据库连接 --------------------------------
	BOOL Open(CString lpszConnect =_T(""), long lOptions = adConnectUnspecified);
	BOOL ConnectDB2(CString dbsrc, CString dbname, CString user, CString pass, long lOptions = adConnectUnspecified);
	BOOL ConnectOracle(CString dbsrc, CString dbname, CString user, CString pass, long lOptions = adConnectUnspecified);
	BOOL ConnectSQLServer(CString dbsrc, CString dbname, CString user, CString pass, long lOptions = adConnectUnspecified);
	BOOL ConnectMySQL(CString driver,CString dbsrc, CString dbname, CString user, CString pass, long lOptions = adConnectUnspecified);
